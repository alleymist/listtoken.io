...
(function(e) {
	...
	n.prototype = {
		...
		create_html: function() {
			...
			var t, n, r;
			var i = '<div class="' + this.options.container_class + '"><div class="image_more_info"><a href="#"><img alt="" src="' + this.options.plugin_url + 'assets/images/more.png"></a></div>';
			this._start = -1;
		...
		_create_arrows: function() {
			...
			if(this.options.hv_switch) {
				if(this.options.border_on_off == 0 || this.options.use_thin_arrows == 1) {
					e = '<div class="circle_slider_nav_left"><img src="' + this.options.plugin_url + 'assets/images/left_vertical2.png" alt="left" /></div>';
					e += '<div class="circle_slider_nav_right"><img src="' + this.options.plugin_url + 'assets/images/right_vertical2.png" alt="right" /></div>'
				} else {
					e = '<div class="circle_slider_nav_left"><img src="' + this.options.plugin_url + 'assets/images/left_vertical.png" alt="left" /></div>';
					e += '<div class="circle_slider_nav_right"><img src="' + this.options.plugin_url + 'assets/images/right_vertical.png" alt="right" /></div>'
				}
			} else {
				if(this.options.border_on_off == 0 || this.options.use_thin_arrows == 1) {
					e = '<div class="circle_slider_nav_left"><img src="' + this.options.plugin_url + 'assets/images/left2.png" alt="left" /></div>';
					e += '<div class="circle_slider_nav_right"><img src="' + this.options.plugin_url + 'assets/images/right2.png" alt="right" /></div>'
				} else {
					e = '<div class="circle_slider_nav_left"><img src="' + this.options.plugin_url + 'assets/images/left.png" alt="left" /></div>';
					e += '<div class="circle_slider_nav_right"><img src="' + this.options.plugin_url + 'assets/images/right.png" alt="right" /></div>'
				}
			}
			return e
		},
